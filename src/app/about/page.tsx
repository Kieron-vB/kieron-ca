...
export default function About() {
	return (
		...
		<Navbar />
		<section className="pt-[7rem] px-[2rem]">
			...
			<div className="flex flex-wrap 2xl:flex-nowrap gap-x-[3vw] gap-y-[5vh] md:gap-y-[8vh] items-start">
				<p className="flex-l sm:max-w-[100vw] 2xl:max-w-[50vw] pt-[2rem] font-body leading-[1.0] tracking-[-0.03em] text-text text-[3vh] lg:text-[5vh]">
				...
				<div className="flex-col self-center w-full" style={{ transform: 'rotate(5deg)' }}>
					...
					/>
					<p className="font-writing text-[3vh] w-full text-center">
